  ...
  switch (type) {
    ...
    case CarComponentTypes.CARMODEL_GET_SUCCESS: {
      return {
        ...
        loading: false,
        error: false,
        allCarModels: payload?.allCarModels,
        carModels: payload?.CarModels,
        totalCarModels: payload?.totalCarModels
      };
    }
    ...
    case CarComponentTypes.BODYTYPE_GET_SUCCESS: {
      return {
        ...
        loading: false,
        error: false,
        allBodyTypes: payload?.allBodyTypes,
        bodyTypes: payload?.BodyTypes,
        totalBodyTypes: payload?.totalBodyTypes
      };
    }
    ...
    case CarComponentTypes.CARNAME_GET_SUCCESS: {
      return {
        ...
        loading: false,
        error: false,
        allCarNames: payload?.allCarNames,
        carNames: payload?.CarNames,
        totalCarNames: payload?.totalCarNames
      };
    }

    case CarComponentTypes.CARNAME_SREACH_GET_LOADING: {
      return { ...state, loading: true, error: false };
    }
    case CarComponentTypes.CARNAME_SREACH_GET_ERROR: {
      return { ...state, loading: false, error: true };
    }
    case CarComponentTypes.CARNAME_SREACH_GET_SUCCESS: {
      return {
        ...state,
        loading: false,
        error: false,
        getCarsByNameSreach: payload?.cars
      };
    }
