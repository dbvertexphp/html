import { Card, Heading, ListItem, OrderedList, Text } from "@chakra-ui/react";
    ...
    <>
      ...
      <Card mx={{ base: "5", md: "20" }} mt="3" mb="20" px="5">
        <Text mt="5" fontWeight={"semibold"}>
          ...
          and conditions of your use of the "EasyGoCarz LLP" Mobile or Web
          application ("Mobile or Web Application" or "Service") and any of its
          related products and services (collectively, "Services"). This
          Agreement is legally binding between you ("User", "you" or "your") and
          this Mobile or Web Application developer ("Operator", "we", "us" or
          "our"). By accessing and using the Mobile or Web Application and
          ...
          may not access and use the Mobile or Web Application and Services. You
          ...
          you, and it governs your use of the Mobile or Web Application and
          Services. This terms and conditions policy was created with the help
        ...
        <Text mt="5">
          You must be at least 16 years of age to use the Mobile or Web
          Application and Services. By using the Mobile or Web Application and
          Services and by agreeing to this Agreement you warrant and represent
          that you are at least 16 years of age.
        </Text>
        <Text mt="5">
          If you create an account in the Mobile or Web Application, you are
        ...
        <Text mt="5">
          Although the Mobile or Web Application and Services may link to other
          resources (such as websites, Mobile or Web applications, etc.), we are
          ...
          resource which you access through a link in the Mobile or Web
          Application and Services. Your linking to any other off-site resources
          is at your own risk.
        </Text>
        ...
        <Text mt="5">
          ...
          prohibited from using the Mobile or Web Application and Services or
          ...
          that will affect the functionality or operation of the Mobile or Web
          Application and Services, third party products and services, or the
          Internet; (h) to spam, phish, pharm, pretext, spider, crawl, or
          scrape; (i) for any obscene or immoral purpose; or (j) to interfere
          with or circumvent the security features of the Mobile or Web
          Application and Services, third party products and services, or the
          Internet. We reserve the right to terminate your use of the Mobile or
          Web Application and Services for violating any of the prohibited uses.
        </Text>
        ...
        <Text mt="5">
          ...
          graphics and logos used in connection with the Mobile or Web
          Application and Services, are trademarks or registered trademarks of
          ...
          Your use of the Mobile or Web Application and Services grants you no
        ...
        <Text mt="5">
          ...
          your Content, your use of the Mobile or Web Application and Services
        ...
        <Text mt="5">
          ...
          and procedural laws of Gujarat, India without regard to its rules on
          ...
          subject matter hereof shall be the courts located in Gujarat, India,
        ...
        <Text mt="5">
          ...
          the Mobile or Web Application and Services at any time, effective upon
          posting of an updated version of this Agreement in the Mobile or Web
          Application. When we do, we will revise the updated date at the bottom
          of this page. Continued use of the Mobile or Web Application and
        ...
        <Text mt="5">
          ...
          terms and conditions. By accessing and using the Mobile or Web
          ...
          authorized to access or use the Mobile or Web Application and
          Services.
        </Text>
        ...
        <Text mt="5">This document was last updated on March 22, 2023</Text>
      </Card>
    </>
  );
}
