...
export default function PrivacyPolicyX() {
  return (
    <>
      <Heading
        mx={{ base: "5", md: "20" }}
      ...
      <Card mx={{ base: "5", md: "20" }} mt="3" mb="20" px="5">
        ...
        <Text mt="5" color="#30829c" fontSize={"20"}>
        ...
        <Text mt="5">For the purposes of this Privacy Policy:</Text>
        <UnorderedList ml="7">
          <ListItem>
          ...
          <ListItem>
            ...
            downloaded by You on any electronic device, named EasyGoCarz LLP
          </ListItem>
          <ListItem>
            Company (referred to as either "the Company", "We", "Us" or "Our" in
            this Agreement) refers to Office, B-180, GreenField Colony,
            Faridabad, Haryana
          </ListItem>
          <ListItem>
          ...
          <ListItem>Country refers to: Haryana, India</ListItem>
          <ListItem>
          ...
          <ListItem>
            Website refers to EasyGoCarz LLP, accessible from
            https://www.easygocarz.com
          </ListItem>
          <ListItem>
        ...
        <Text mt="5">Last updated: March 22, 2023</Text>
      </Card>
    </>
  );
}
