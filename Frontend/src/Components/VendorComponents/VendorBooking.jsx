...
import { getBookingsByVendorId } from "../../Redux/App/Actions/Booking.action";
...
const VendorBooking = () => {
  ...
  const vendorDetails = JSON.parse(
    localStorage.getItem("vendor_detail_carvendor")
  );
  ...
  const getData = () => {
    ...
    dispatch(getBookingsByVendorId(vendorDetails?._id, params, vendortoken));
  };
