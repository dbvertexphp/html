...
const ReportCustomer = () => {
  ...
  let { totalCustomers, customers, loading, error } = useSelector(
    (store) => store?.CustomerManager
  );
  ...
  return (
    <Box padding={"20px"}>
      ...
      >
        <Text w="full">
          Total Records Count : {totalCustomers || customers.length || 0}
        </Text>
      </VStack>
      <br />
      <VStack
