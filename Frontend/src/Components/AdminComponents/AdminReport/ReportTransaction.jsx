...
const ReportTransaction = () => {
  ...
  const { totalTransactions, transactions, loading, error } = useSelector(
  ...
  return (
    <Box padding={"20px"}>
      ...
      >
        ...
        <Text w="full">
          Total Test Drive Transactions :{" "}
          {transactions?.filter(
            (el) => el.transaction_type == "Test Drive Booking"
          )?.length || 0}
        </Text>
        <Text w="full">
          Total Booking Transactions :{" "}
          {transactions?.filter(
            (el) => el.transaction_type == "Booking Car 10% Pay"
          )?.length || 0}
        </Text>
      </VStack>
      <br />
        ...
        <VStack w="full" mb={5}>
          ...
          <HStack w="full">
            ...
            >
              ...
              <option value="Booking Car 90% Pay">
                Booking Car Full Payment{" "}
              </option>
