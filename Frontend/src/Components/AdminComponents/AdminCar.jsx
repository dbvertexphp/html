...
import { UpdateCarByID, getCarByID, getCarsAdmin, getCarsByVendorID } from '../../Redux/App/Actions/Vendors/Car.action';
...
const AdminCar = () => {
  ...
  const handleFeaturedInChange = (id, key) => {
    ...
    data = { ...data, [key]: 1 };
    dispatch(UpdateCarByID(id, data, toast, getData, 'Updated Car Status Successfully', admintoken));
  };
  ...
  const handleStatusChange = (value, id) => {
    ...
    dispatch(UpdateCarByID(id, data, toast, getData, 'Status Updated Successfully', admintoken));
  };
    ...
    <Container maxW="container" borderRadius="5px" minH={'610px'} padding={'20px'} backgroundColor={'white'}>
      ...
      >
        <Table size={'sm'} variant="striped" border={'1px solid #ddd'}>
          <Thead backgroundColor={'white'} position={'sticky'} top="0" border={'1px solid white'}>
            <Tr>
                  ...
                  <Tr key={row?._id}>
                    ...
                    <Td sx={cellStyle}>
                      ...
                      <Select
                        ...
                        onChange={e => handleFeaturedInChange(row?._id, e.target.value)}
                        fontWeight={500}
                      >
                        <option value="" style={{ color: 'orange' }}>
                          Select category
                        </option>
                        <option value="featured_car" style={{ color: 'orange' }}>
                          Featured Car
                        </option>
                        <option value="upcoming_car" style={{ color: 'purple' }}>
                          Upcoming Car
                        </option>
                    ...
                    <Td sx={{ ...cellStyle, textAlign: 'center' }}>
                      <Box display={'flex'} p={1}>
                        <Select
                          ...
                          borderRadius={'5px'}
                          onChange={e => {
                            if (e.target.value == 'rejected' || e.target.value == 'deactivate') {
                        ...
                        >
                          ...
                          <option value="under review" style={{ color: 'purple' }}>
                            Under Review
                          </option>
      ...
      />
      {/**<!--*------- <Disable Poput> ----------->*/}
      <AlertDialog isCentered isOpen={isOpen1} leastDestructiveRef={cancelRef} onClose={onClose1}>
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogBody>Are you sure? You want to change this car's status to {Ostatus?.toUpperCase()}</AlertDialogBody>
