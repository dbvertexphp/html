import { Box, Button, Card, Heading, Image, Table, TableContainer, Tbody, Td, Flex, Text, Th, Thead, Tr, Spinner } from '@chakra-ui/react';
                  ...
                  return (
                    <Tr key={item._id}>
                      ...
                      <Td sx={cellStyle}>
                        ...
                        <div>
                          <b>Booking Amount : {item?.test_drive_booking_amount}</b>
                        </div>
                        <div>
                      ...
                      <Td sx={cellStyle}>
                        <Box display={'flex'} justifyContent={'center'} ml={'-20px'}>
                          <Button
                            borderRadius={'5px'}
                            bg={item.status === 'paid' ? 'green.500' : item.status === 'pending' ? 'orange.500' : 'blue.500'}
                            color={'white'}
                            size={'xs'}
                            variant={'ghost'}
                            border={'1px solid'}
