...
const { getAllCarModels, getCarModelByID, addCarModel, UpdateCarModelByID, DeleteCarModelByID } = require("../Controllers/CarComponents/CarModel.controller");
const { getAllCarNames, addCarName, UpdateCarNameByID, DeleteCarNameByID, getCarNames } = require("../Controllers/CarComponents/CarName.controller");
...
const { getAllLocations, getLocationByID, addLocation, UpdateLocationByID, DeleteLocationByID, getLocations } = require("../Controllers/CarComponents/Location.controller");
