                                                          ...
                                                          <tr>
                                                              <td class="pad">
                                                                  <div style="color:#101112;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                      ...
                                                                      <p style="margin: 0; margin-bottom: 16px;">Thank you for signing up with easygocarz.com! To complete the registration process and ensure the security of your account, please enter the following One-Time Passcode (OTP) in the provided space on our website:</p>
                                                                      <br>
                                                                      <h3 style="margin: 0; margin-bottom: 16px;">OTP: ${otp}</h3>
