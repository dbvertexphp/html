const CustomerDisableCustomer = (customer) => {
                                                            ...
                                                            <tr>
                                                                <td class="pad">
                                                                    <div style="color:#101112;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                        ...
                                                                        <br>
                                                                        <a href="https://easygocarz.com/contactus">Contact Us</a>
                                                                        <br>
...
const CustomerDisableAdmin = (customer) => {
  let customer_code = customer.customer_code;
  let customer_name = customer.first_name + " " + customer.last_name;
  let customer_email = customer.email;
  return `<!DOCTYPE html>
                                                        ...
                                                        <table class="paragraph_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                            <tr>
                                                                <td class="pad">
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 16px;">
                                                                    The following customer's account has been temporarily disabled. </p>
                                                                    <br>
                                                                    <p style="margin: 0; margin-bottom: 16px;">
                                                                    ...
                                                                    <br>If not done by you, Please Contact Support Team.
                                                                    </p>
                                                                    <br>
                                                                    <a href="https://easygocarz.com/contactus">Contact Us</a>
                                                                    <br>
...
module.exports = { CustomerDisableCustomer, CustomerDisableAdmin };
